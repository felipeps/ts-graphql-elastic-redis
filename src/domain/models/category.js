...
var Category = function () {
    ...
    (function () {
        ...
        _id_decorators = [(0, type_graphql_1.Field)(function (_type) { return Number; }), (0, typeorm_1.PrimaryGeneratedColumn)()];
        _name_decorators = [(0, type_graphql_1.Field)(function () { return String; }), (0, typeorm_1.Column)({ type: 'varchar' })];
        _products_decorators = [(0, type_graphql_1.Field)(function (type) { return [product_js_1.Product]; }), (0, typeorm_1.OneToMany)(function () { return product_js_1.Product; }, function (product) { return product.category; })];
